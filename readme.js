export default async function handler(req, res) {
  ...
  <svg width="420" height="120" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="20" y="35" font-family="Arial, sans-serif" font-weight="bold" font-size="16" fill="#cba6f7">🔍 Visitor Network Info</text>
    <text x="20" y="65" font-family="monospace" font-size="14" fill="#a6e3a1">IP Address: ${ip}</text>
    <text x="20" y="85" font-family="monospace" font-size="14" fill="#89b4fa">ISP/Location: ${isp} (${country})</text>
    <text x="20" y="105" font-family="monospace" font-size="14" fill="${quality.includes('⚠️') ? '#f38ba8' : '#a6e3a1'}">IP Quality: ${quality}</text>
  </svg>
  `;
